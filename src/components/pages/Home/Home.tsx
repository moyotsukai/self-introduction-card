      ...
      {items === null
        ? (
          <div className={styles.inputTextContainer}>
            <input type="text" placeholder="名前を入力しよう！" value={name} onChange={onChangeName} onKeyDown={onKeyDownOnAddName} autoComplete="off" className={styles.inputText} />
        ...
        : (
          <div className={styles.inputTextContainer}>
            <input type="text" placeholder="自分を構成する要素を書こう！" value={currentItem} onChange={onChangeCurrentItem} onKeyDown={onKeyDownOnAddItem} autoComplete="off" className={styles.inputText} />
